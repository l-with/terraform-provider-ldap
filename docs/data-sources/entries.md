...
- `paging_size` (Number) Desired page size for the search request. Use -1 to retrieve all results without pagination, or a value greater than 0 to enable paginated queries. Defaults to 100.
